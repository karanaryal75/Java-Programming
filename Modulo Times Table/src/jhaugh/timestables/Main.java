 ...
 * 09/13/2020
 */
package jhaugh.timestables;// Feel free to change the package
...
public class Main extends Application {
    ...
    public static final double HEIGHT = 724;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        final Circle circle = new Circle(WIDTH / 2, HEIGHT / 2, 250);
        ...
        controls.getChildren().addAll(
                ...
                jumpToLabel, timesTableNumBox, run, pause, numPointsBox, jumpToButton);
        // Create the canvas
        ...
        Visualization visualization = new Visualization(ttn, 250);
        // The main "loop"
